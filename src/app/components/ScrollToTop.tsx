    ...
    <AnimatePresence>
      {isVisible && (
        <motion.button
          ...
          className="md:hidden group fixed bottom-24 right-8 z-[100] min-w-[48px] min-h-[48px] flex items-center justify-center bg-surface-0 border border-border-0 text-accent-primary rounded-full transition-colors duration-200 hover:bg-accent-tint hover:border-accent-primary hover:shadow-[0_6px_20px_-6px_var(--accent-primary)] focus:outline-none focus:ring-2 focus:ring-focus-ring"
